    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(
                "https://ec2-18-222-167-54.us-east-2.compute.amazonaws.com:4003/api/reviews/analyzeReviews",
                formData,
                {
                    headers: {
    ...
    const generatePdf = () => {
        ...
        html2canvas(chartRef.current).then((canvas) => {
            ...
            html2canvas(document.querySelector('.recharts-responsive-container')).then((canvas) => {
                ...
                axios.post(
                    `https://ec2-18-222-167-54.us-east-2.compute.amazonaws.com:4003/api/reviews/addFile/${localStorage.getItem("userId")}`,
                    formData,
                    {
                        headers: {
                            "Content-Type": "multipart/form-data",
